...
exports.PlayFabApiTests = {
    ...
    UserStatisticsApi: function (test) {
    ...
    CloudScript: function (test) {
        if (PlayFab.settings.logicServerUrl == null) {
