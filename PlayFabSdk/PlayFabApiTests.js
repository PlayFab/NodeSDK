...
var PlayFabAdmin = require("./Scripts/PlayFab/PlayFabAdmin"); // Not strictly needed for this test, but I want to make sure it compiles/loads
var PlayFabMatchmaker = require("./Scripts/PlayFab/PlayFabMatchmaker"); // Not strictly needed for this test, but I want to make sure it compiles/loads
var PlayFabClient = require("./Scripts/PlayFab/PlayFabClient");
var PlayFabServer = require("./Scripts/PlayFab/PlayFabServer");
var fs = require("fs");
