...
exports.ActivateKey = function (request, callback) {
    PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/APIKey/ActivateKey", request, "X-EntityToken", PlayFab._internalSettings.entityToken, function (error, result) {
...
exports.CreateKey = function (request, callback) {
    PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/APIKey/CreateKey", request, "X-EntityToken", PlayFab._internalSettings.entityToken, function (error, result) {
...
exports.DeactivateKey = function (request, callback) {
    PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/APIKey/DeactivateKey", request, "X-EntityToken", PlayFab._internalSettings.entityToken, function (error, result) {
...
exports.DeleteKey = function (request, callback) {
    PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/APIKey/DeleteKey", request, "X-EntityToken", PlayFab._internalSettings.entityToken, function (error, result) {
...
exports.GetKeys = function (request, callback) {
    PlayFab.MakeRequest(PlayFab.GetServerUrl() + "/APIKey/GetKeys", request, "X-EntityToken", PlayFab._internalSettings.entityToken, function (error, result) {
