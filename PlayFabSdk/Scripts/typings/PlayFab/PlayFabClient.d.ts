declare module PlayFabClientModule {
    export interface IPlayFabClient {
        ...
        GetPlayFabIDsFromOpenIdSubjectIdentifiers(
            request: PlayFabClientModels.GetPlayFabIDsFromOpenIdsRequest | null,
            callback: PlayFabModule.ApiCallback<PlayFabClientModels.GetPlayFabIDsFromOpenIdsResult> | null,
        ): void;
        ...
        LinkBattleNetAccount(
            request: PlayFabClientModels.LinkBattleNetAccountRequest | null,
        ...
        UnlinkBattleNetAccount(
            request: PlayFabClientModels.UnlinkBattleNetAccountRequest | null,
            callback: PlayFabModule.ApiCallback<PlayFabClientModels.EmptyResponse> | null,
        ): void;
