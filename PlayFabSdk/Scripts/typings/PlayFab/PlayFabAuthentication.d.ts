declare module PlayFabAuthenticationModule {
    export interface IPlayFabAuthentication {
        ...
        ActivateKey(request: PlayFabAuthenticationModels.ActivateAPIKeyRequest, callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.ActivateAPIKeyResponse>): void;
        // Creates an API key for the given entity.
        // https://api.playfab.com/Documentation/Authentication/method/CreateKey
        CreateKey(request: PlayFabAuthenticationModels.CreateAPIKeyRequest, callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.CreateAPIKeyResponse>): void;
        ...
        DeactivateKey(request: PlayFabAuthenticationModels.DeactivateAPIKeyRequest, callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.DeactivateAPIKeyResponse>): void;
        // Deletes the given API key.
        // https://api.playfab.com/Documentation/Authentication/method/DeleteKey
        DeleteKey(request: PlayFabAuthenticationModels.DeleteAPIKeyRequest, callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.DeleteAPIKeyResponse>): void;
        ...
        GetKeys(request: PlayFabAuthenticationModels.GetAPIKeysRequest, callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.GetAPIKeysResponse>): void;
